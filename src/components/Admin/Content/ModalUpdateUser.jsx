...
function ModalUpdateUser(props) {
  ...
  //
  useEffect(() => {
    console.log("userEffetct", dataUpdate);
    console.log("email", email);
    console.log(_.isEmpty(dataUpdate));
  ...
  const handleSubmitCreateUser = async () => {
    ...
    console.log(
      "🚀 ~ file: ModalUpdateUser.jsx:54 ~ handleSubmitCreateUser ~ data:",
      data
    );
    //EC --> error code
    //EM --> error mess
  ...
  console.log("data-update-props", props.dataUpdate);
  return (
    <>
